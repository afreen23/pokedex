...
var location_endpoint = "location-area"

var pokemon_endpoint = "pokemon"
...
func GetLocation[T int | string](id T) ([]byte, error) {
...
func GetPokemon(name string) ([]byte, error) {
	fetch_url := fmt.Sprintf("%s/%s/%s", base_url, pokemon_endpoint, name)
